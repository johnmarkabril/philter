<div class="padding-top">
	<div class="ibox no-margin">
		<div class="ibox-title no-border text-bold">
			...
			<?php 
				if ( !empty($get_specific_feature) ) {
					foreach ( $get_specific_feature as $sb ) :
			?>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content animated rotateInUpRight">
		        ...
		        <div class="modal-body padding-all">
		        	<form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/feature/update">
	...
	<div class="modal inmodal" id="blogCreate" tabindex="-1" role="dialog"  aria-hidden="true">
	    <div class="modal-dialog">
	        <div class="modal-content animated rotateInUpRight">
		        ...
		        <div class="modal-body padding-all">
		        	<form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/feature/insert">
			            <div class="form-group">
			                <label>Title</label>
