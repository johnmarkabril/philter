<div class="padding-top">
	<div class="ibox no-margin">
		<div class="ibox-title no-border text-bold">Entertainment list</div>
                ...
                <tbody>
                	<?php
                		if ( !empty($get_all_entertainment) ) {
                			foreach ( $get_all_entertainment as $gab ) :
                	?>
			                	<tr>
			                		<td><a href="<?php echo base_url(); ?>admin/blog/post/<?php echo $gab->NO; ?>"><?php echo $gab->TITLE; ?></a></td>
			                		<td>
			                			<a href="<?php echo base_url(); ?>admin/entertainment/delete/<?php echo $gab->NO; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
			                		</td>
			                	</tr>
			        <?php
			        		endforeach;
