<div class="padding-top">
	<div class="ibox-content padding-five bg-nav_log">
		<h3 class="no-margin nav-log-color" style="padding-left: 15px;padding-right: 15px;">Entertainment<span class="pull-right"><a href="<?php echo base_url(); ?>entertainment" style="color: #FFFFFF;">Back</a></span></h3>
	</div>
</div>

<?php
	foreach ( $get_specific_entertainment as $gse ) :
?>
		<div class="padding-top">
...
<div class="padding-top">
	<div class="ibox-content no-border">
		...
		<div class="form-group no-margin">
			<form method="POST" class="no-margin" action="<?php echo base_url(); ?>entertainment/insertcomment">
